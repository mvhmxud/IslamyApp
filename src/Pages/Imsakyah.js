...
function Imsakyah(props) {
    ...
    navigator.geolocation.getCurrentPosition((location) => {
      ...
      navigator.permissions
        ...
        .then((permissions) => {
          ...
          axios
            .get(
              `https://api.aladhan.com/v1/hijriCalendar?latitude=${location.coords.latitude}&longitude=${location.coords.longitude}&month=9&year=1443&adjustment=-1`
            )
            .then((res) => {
  ...
  return (
    <div className="h-screen bg-background dark:bg-darkmodeDark">
      <NavBar
